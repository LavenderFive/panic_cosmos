...
class Channel:
    def __init__(
        self, channel_name: str, logger: logging.Logger, redis: Optional[RedisApi]
    ) -> None:
...
class ChannelSet:
    ...
    def enabled_channels_list(self) -> str:
        return (
            ", ".join([type(c).__name__ for c in self._channels])
