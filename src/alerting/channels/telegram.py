...
class TelegramChannel(Channel):
    ...
    def alert_info(self, alert: Alert) -> None:
        self._alert(
            alert=alert, subject="{}{}INFO".format(self.channel_name, self._space)
        )

    def alert_minor(self, alert: Alert) -> None:
        self._alert(
            alert=alert, subject="{}{}MINOR".format(self.channel_name, self._space)
        )

    def alert_major(self, alert: Alert) -> None:
        self._alert(
            alert=alert, subject="{}{}MAJOR".format(self.channel_name, self._space)
        )

    def alert_error(self, alert: Alert) -> None:
        self._alert(
            alert=alert, subject="{}{}ERROR".format(self.channel_name, self._space)
        )
